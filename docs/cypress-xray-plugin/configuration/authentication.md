...
You _must_ do this by setting up specific environment variables, e.g. a client ID and a client secret when using a cloud based Xray instance.
...
Depending on your Jira version, you may either need to use Jira's _Personal Access Tokens_ (PATs) to authenticate to Jira, or _Basic Authentication_ using your Jira username and password.
