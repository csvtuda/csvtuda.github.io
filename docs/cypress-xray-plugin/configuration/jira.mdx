...
:::warning[Scoped API tokens]

If you use scoped API tokens, the URL needs to be of the form `https://api.atlassian.com/ex/jira/your-cloud-id` (see [here](https://support.atlassian.com/atlassian-account/docs/manage-api-tokens-for-your-atlassian-account/))!
...
For example, the assignee may need to be set using the `name` property instead of account IDs (see [FAQ](../guides/faq.mdx#assigning-issues)).

:::

You can do cool things here, including:

- [setting assignees](../guides/faq.mdx#assigning-issues)
...
Will be removed in version `9.0.0`.
To define a description, please use [`description`](#description) instead:
...
Will be removed in version `9.0.0`.
To define a summary, please use [`summary`](#summary) instead:
