...
:::danger **Error: unable to get issuer certificate**

<!-- nothing -->

:::

:::danger **Error: unable to verify the first certificate**
...
:::danger **Error: unsafe legacy renegotiation disabled**
...
:::danger **Error: Request failed with status code 502**
...
:::danger **Error assembling issue data: expected Object containing a `name` property**
...
:::danger **Request failed with status code 429**
...
:::danger **RangeError: Invalid string length**
...
The plugin is able to split result uploads into multiple requests using the [`splitUploads`](../configuration/plugin.mdx#splitupload) setting.
