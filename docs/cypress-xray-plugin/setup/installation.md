...
You can also shoot a glance at the [examples](../guides/uploadTestResults.mdx#how-it-works) for a more hands-on approach.
...
See [here](../guides/featureFileSynchronization.mdx) for more information.
