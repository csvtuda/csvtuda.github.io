...
Before you read this article you should be familiar with the QTAF framework. You can read <a href="articles/New_QTAF_Project.html" target="_blank">this</a> article if you want to understand the Java code which is shown here.
...
<video width="320" height="240" controls>
  <source src="video/vscode/extension_pack_for_java_installation.mp4" type="video/mp4">
