...
You can find an example of an HTML report here: <a href="html_report/suite_crm/Report.html" target="_blank">QTAF HTML Report</a>

You can also find an example JSON report here: <a href="json_report/suite_crm/Report.json" target="_blank">QTAF JSON Report</a>
